...
Use ClipSearch when the user asks you to find visual reference images, real-world image examples, aesthetic references, people, locations, objects, scenes, backgrounds, thumbnail reference material, or similar imagery.
